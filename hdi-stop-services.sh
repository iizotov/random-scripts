...
usage() {
    echo ""
    echo "Usage: sudo -E bash $0 <service0-to-stop> [<service1-to-stop>] [<service2-to-stop>] ... [<serviceN-to-stop>]" ;
...
if [ -z "$1" ]
    then
        usage
        echo "Error: at least one service should be provided."
        exit 137
fi
